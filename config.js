...
SolarApp.Config = (function () {
  ...
  const DEFAULTS = {
    ...
    utility: {
      billImportMode: "client-side-bill-upload",
      note: "TNEB/TNPDCL data is read from the customer-supplied bill in the browser. No portal username/password is required."
    },
